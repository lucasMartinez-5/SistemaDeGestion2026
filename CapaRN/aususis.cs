...
namespace CapaRN
{
	public class aususis {
		...
		#region Propiedades
		    ...
		    public bool causactpass
            { 
                get{ return this._causactpass;}
                set{ this._causactpass = value;}
            } 
        ...
        #region Metodos
            ...
            { 
                ...
                if (ResultadoConsulta.Read())
                {
                    ...
                    this._causactpass=ResultadoConsulta.GetBoolean(3);
            ...
            { 
                ...
                { 
                    ...
                    this.Conexion.AsignarParametroLogico("@causactpass",this._causactpass);
            ...
            { 
                ...
                if (ResultadoConsulta!=null)
                {
                    while (ResultadoConsulta.Read())
                    {
                          ...
                          Auxiliar.causactpass = ResultadoConsulta.GetBoolean(3);
